...
def savefile(money: int, difficulty: int, statistics: list[int], upgrades: dict):
    file = open(".\data\save.txt", "w") 
...
def readfile():
    try:
        ...
        upgrades = {"trap_chance": 0, "lootrooms": 0, "traps": 0, "die_chance": 0, "thread_chance": 0, "torch_time": 0}     
        i = 0
        ...
        return 0, 0, [0, 0, 0], {"trap_chance": 0, "lootrooms": 0, "traps": 0, "die_chance": 0, "thread_chance": 0, "torch_time": 0}
    finally:
        file.close()
