...
class Map():
    ...
    def generate_new_map(self):
        ...
        escapes = [(i,j) for i in range(12) for j in range(2) if not self.matrix[i][j].generated]
        ...
        everything_else = [(i,j) for i in range(12) for j in range(12) if not self.matrix[i][j].generated]
        ...
        for i in range(self.basics, self.basics+self.lootrooms): #loot room generation
            if self.matrix[everything_else[i][0]][everything_else[i][1]].generated:
                print("Błąd podczas generacji")
            self.matrix[everything_else[i][0]][everything_else[i][1]].state = 1
            self.matrix[everything_else[i][0]][everything_else[i][1]].generated = True

        for i in range(self.basics+self.lootrooms, self.basics+self.lootrooms+self.traps): #traps generation
            if self.matrix[everything_else[i][0]][everything_else[i][1]].generated:
                print("Błąd podczas generacji")
    ...
    def interact(self):
        ...
        if interacted_room.interacted == False:
